...
import { RefreshCw, Landmark, Flame, ArrowDown } from "lucide-react";
    ...
    <div className="min-h-screen pb-20 bg-background">
      <header className="sticky top-0 z-40 bg-background/95 backdrop-blur-xl border-b border-border/40">
        <div className="max-w-lg mx-auto flex items-center px-5 h-14">
          <h1 className="font-display font-bold text-base">Exchange</h1>
        </div>
      </header>
      ...
      <div className="max-w-lg mx-auto px-5 py-5 space-y-5">
        ...
        <div className="card-clean p-5 text-center">
          ...
          <p className="text-[11px] text-muted-foreground font-body mt-2">Comissão: 5% • Destino: Treasury WageCompany</p>
        </div>
        ...
        <div className="card-clean p-5 space-y-4">
          <div>
            ...
            <button
              ...
              className="text-[11px] text-primary font-body font-medium mt-1.5 tap-shrink"
            >
              Usar máximo
            </button>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3 rounded-xl bg-secondary p-3">
              ...
              <span className="flex-1 font-display font-bold text-xl text-primary">
                {wageOut.toFixed(4)}
              </span>
          ...
          <motion.button
            ...
            className="w-full py-3 rounded-xl font-display font-semibold text-sm disabled:opacity-30 tap-shrink bg-primary text-primary-foreground"
          >
            Converter para $WAGE
          </motion.button>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2.5">
          {[
            { icon: <Landmark size={18} className="text-foreground" />, title: "Treasury", desc: "Comissão sustenta o ecossistema WageCompany" },
