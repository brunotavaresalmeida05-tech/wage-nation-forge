...
const WalletCard = ({ mineBalance, wageBalance, wageUsdRate }: WalletCardProps) => {
  ...
  return (
    <motion.div
      ...
      className="rounded-2xl p-5 bg-card-elevated border border-border/40"
    >
      ...
      <div className="flex gap-2 mt-5">
        <button className="flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl bg-secondary text-foreground text-xs font-body font-medium tap-shrink">
        ...
        <button
          ...
          className="flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl bg-primary text-primary-foreground text-xs font-body font-medium tap-shrink"
        >
          <ArrowDownUp size={14} />
          Swap
        </button>
